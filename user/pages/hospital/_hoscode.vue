  ...
  <div class="nav-container page-component">
    ...
    <div class="nav left-nav">
      <div class="nav-item selected">
        <span class="v-link selected dark" :onclick="'javascript:window.location=\'/hospital/'+hospital.hospCode+'\''">预约挂号 </span>
      </div>
      <div class="nav-item ">
        <span class="v-link clickable dark" :onclick="'javascript:window.location=\'/hospital/detail/'+hospital.hospCode+'\''"> 医院详情 </span>
      </div>
      <div class="nav-item">
        <span class="v-link clickable dark" :onclick="'javascript:window.location=\'/hospital/notice/'+hospital.hospCode+'\''"> 预约须知 </span>
      </div>
      ...
      <div class="hospital-home">
        <div class="common-header">
          <div class="title-wrapper"><span
            class="hospital-title">{{ hospital.hospName }}</span>
        ...
        <div class="info-wrapper">
          <img class="hospital-img" :src="'data:image/jpeg;base64,'+hospital.picture" :alt="hospital.hospName">
...
export default {
  ...
  methods: {
    ...
    schedule(depcode) {
      ...
      window.location.href = '/hospital/schedule?hoscode=' + this.hospital.hospCode + "&depcode=" + depcode
    }
  }
}
</script>
