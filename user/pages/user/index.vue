    ...
    <div class="page-container">
      <div>
        ...
        <div class="status-bar">
          <div class="status-wrapper"><span class="iconfont" v-if="userInfo.authStatus !== 2"></span>{{ authStatusString }}</div>
        </div>
        <div class="tips"><span class="iconfont" v-if="userInfo.authStatus !== 2"></span>
    ...
    getUserInfo() {
      userInfoApi.getUserInfo().then(response => {
        ...
        if(this.userInfo.authStatus === 1){
          this.authStatusString = "待审核" 
        }else{
          this.authStatusString = "已实名认证"
        }
      })
    },
