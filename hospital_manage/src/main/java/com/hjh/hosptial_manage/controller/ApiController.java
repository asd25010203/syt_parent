...
public class ApiController extends BaseController {
	...
	public String login (@RequestParam String userName,HttpServletRequest request){
		request.getSession().setAttribute("hospCode",userName);
		return "frame/index";
	}

	@RequestMapping("/hospitalSet/index")
	public String getHospitalSet(ModelMap model,HttpServletRequest request) {
		QueryWrapper queryWrapper = new QueryWrapper();
		queryWrapper.eq("hoscode",request.getSession().getAttribute("hospCode"));
