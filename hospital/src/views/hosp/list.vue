...
<div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list"
        ...
        <el-table-column label="医院logo">
            <template slot-scope="scope">
            <img :src="'data:image/jpeg;base64,'+scope.row.picture" width="80">
            </template>
        </el-table-column>
        ...
        <el-table-column label="操作" width="230" align="center">
            <template slot-scope="scope">
                ...
                <router-link :to="'/hospSet/hospital/schedule/'+scope.row.hospCode">
                    <el-button type="primary" size="mini">排班</el-button>
                </router-link>

                <el-button v-if="scope.row.status == 1"  type="primary" size="mini" @click="updateStatus(scope.row.hospCode, 0)">下线</el-button>
                <el-button v-if="scope.row.status == 0"  type="danger" size="mini" @click="updateStatus(scope.row.hospCode, 1)">上线</el-button>
            </template>
